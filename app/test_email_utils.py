...
class TestBodyFormat(unittest.TestCase):
    ...
    def test_format_body(self):
        ...
        """
        actual_text = email_utils.format_body('<li>test1</li><li>test2</li>')
        self.assertEqual(expected_text, actual_text)

class TestFormatConfirmationEmail(unittest.TestCase):
    def test_format_confirmation_email(self):
        expected = \
        """<html>
        <head>
        ...
        actual = email_utils.format_confirmation_email(True)
